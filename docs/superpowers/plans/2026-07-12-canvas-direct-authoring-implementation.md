...
- [x] **Step 1: Write failing tests for valid and invalid lane ownership**
...
- [x] **Step 3: Implement optional lane metadata and validation**
...
- [x] **Step 1: Write a failing grid-layout test**
...
- [x] **Step 2: Verify the layout test is red**
...
- [x] **Step 3: Implement the lane grid without changing the legacy path**
...
- [x] **Step 4: Verify layout and performance green**
...
- [x] **Step 1: Write failing author UI tests**
...
- [x] **Step 2: Verify author UI tests are red**
...
- [x] **Step 3: Implement management and overlays**
...
- [x] **Step 4: Verify author UI green**
...
- [x] **Step 1: Write failing direct-authoring tests**
...
- [x] **Step 2: Verify direct-authoring tests are red**
...
- [x] **Step 3: Create controlled overlay components**
...
- [x] **Step 4: Wire atomic document changes into GuideEditor**
...
- [x] **Step 5: Verify direct authoring green**
...
- [x] **Step 1: Write failing learner-responsibility tests**
...
- [x] **Step 2: Verify learner tests are red**
...
- [x] **Step 3: Implement learner context and accurate docs**
...
- [x] **Step 4: Verify learner behavior green**
...
- [x] **Step 5: Run full verification and browser acceptance**
